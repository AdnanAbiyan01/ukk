...
class ProductsController extends AppController
{
    ...
    {
        $product = $this->Products->get($id, contain: ['Supliers', 'Categories', 'Transaction']);
    ...
    public function add()
    {
        ...
        $supliers = $this->Products->Supliers->find('list', limit: 200)->all();
        $categories = $this->Products->Categories->find('list', limit: 200)->all();
        $this->set(compact('product', 'supliers', 'categories'));
    }
