 ...
 * Products Model
 *
 * @property \App\Model\Table\SupliersTable&\Cake\ORM\Association\BelongsTo $Supliers
...
class ProductsTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['suplier_id'], 'Supliers'), ['errorField' => 'suplier_id']);
