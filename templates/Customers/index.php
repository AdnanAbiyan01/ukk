...
<div class="card card-primary card-outline">
    <div class="card-header d-flex flex-column flex-md-row">
        ...
        <div class="d-flex ml-auto">
            ...
            <?= $this->Html->link(__('New Customer'), ['action' => 'add'], ['class' => 'btn btn-primary btn-sm ml-2']) ?>
        </div>
    </div>
    <!-- /.card-header -->
                ...
                <?php foreach ($customers as $customer) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <?= $this->Html->link(__('Edit'), ['action' => 'edit', $customer->id], ['class' => 'btn btn-xs btn-outline-primary', 'escape' => false]) ?>
